...
public class ImplementationExample {
    ...
    private static class TestClass {
        ...
        public String getString() {
    	    return "TestValue";// 해당 문자열을 반환하게 만들었고-> (1) 완료
        }
         ...
         */
    	public String eval(String first, int data) {// 첫번째 값 : first, 두번째 값 : data
    		int A = (data / 2) * 7;
    		int result = (int) (Math.pow(A, 3) / 5);
    	    return first + " - " + result;
    	}
