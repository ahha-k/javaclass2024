...
public class EncapsulationExample {
    ...
    private static abstract class Car {
        ...
        public void setRealFuelEfficiency(double realFuelEfficiency) {
        	// this.realFuelEfficiency = realFuelEfficiency; 코드가 되기 위해서는 최대 연비를 넘으면 안됨, 그래서 15.0인 퍼포먼스맨퓨레이션이 적용되면 안됨
        	// 그럼 그냥 this보다 작은 경우 버리면 됨. throw new 구문사용해서 버리라고 하심.
        	if (this.realFuelEfficiency<realFuelEfficiency) {
        		throw new RuntimeException("오류");
        	}//교수님이 이 코드를 지우고 사용하세요, 하신 문제 코드에서 따왔음.
            this.realFuelEfficiency = realFuelEfficiency;//앞에 this 가 7.5고 내가 받은게 뒤에 연비
        }
    }
