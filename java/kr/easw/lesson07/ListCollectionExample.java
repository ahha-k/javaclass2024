 ...
 *  : 그냥 scanner 썼으면 다시 비워줘라!!!< 이정도만 알면될 것 같음
 */
public class ListCollectionExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("> ");
        int next = scanner.nextInt();// scanner를 썼으면 다시 비우는 과정이 필요하다.
        scanner.nextLine(); //추가부분-------------------------------------------
        ...
        for (int i = 0; i < next; i++) {
            ...
            System.out.print("> ");
            int age = scanner.nextInt();//위와 마찬가지로 썼으면 지우기
            scanner.nextLine(); //추가부분-------------------------------------------
