...
public class LambdaExample {
    ...
    //---------------------------------------------------------------------------------------
    //위에까지는 고칠 것 없음. 아래만 고치면 됨.
    //위와 같은 형태를 사용할 것.
    
    // BiFunction<Integer, Integer, Integer> adjuster = (number, adjustment) -> number + adjustment; < 참고하기
    private static int lambdaResult(int base, int delta) {
        ...
        return operation.apply(base, delta);
    }
...
U: 두 번째 매개변수의 타입입니다.
R: 반환 타입입니다.
출처: https://developer-talk.tistory.com/716 [DevStory:티스토리]
