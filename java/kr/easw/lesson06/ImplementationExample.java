...
// 까지는 고칠 것 없음 ----------------------------------------
    ...
    final static class Cat implements Animal {// 위 bark에서 그냥 meow로 바꾸면 동일 그대로 따오고 해당 부분 수정
        private void meow() {
    ...
    final static class Horse implements Animal {// 위 bark에서 그냥 neigh로 바꾸면 동일
        private void neigh() {
